...
$(document).on('shiny:sessioninitialized', function () {
  ...
  function localize(selector, opts) {
    ...
    $els.each(function (idx) {
      var optsItem = $.extend({}, opts); // Note: `this.dataset.i18nOpts` maps directly to the DOM element attribute `data-i18n-opts`
  ...
  $(document).on('i18n', function (ev) {
    ...
    localize(ev.target); // and also any descendants
