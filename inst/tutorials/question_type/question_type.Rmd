...
question_completed_ui.no_feedback <<- function(question, input_answer, ...) {
...
question_is_correct.text_no_trim <<- function(question, input_answer, ...) {
  ...
  for (ans in question$answers) {
    if (identical(ans$option, input_answer)) {
