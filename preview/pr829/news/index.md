...
- Text throughout the learnr interface can be customized or localized
  ...
  [`vignette("multilang", package = "learnr")`](https:/pkgs.rstudio.com/learnr/preview/pr829/articles/multilang.md).
...
- `learnr` gained the function
  [`learnr::tutorial_package_dependencies()`](https:/pkgs.rstudio.com/learnr/preview/pr829/reference/tutorial_package_dependencies.md),
  ...
  [`learnr::available_tutorials()`](https:/pkgs.rstudio.com/learnr/preview/pr829/reference/available_tutorials.md)
