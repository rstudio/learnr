...
- [`safe()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/safe.md) :
...
- [`tutorial_package_dependencies()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/tutorial_package_dependencies.md)
...
- [`correct()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/mark_as_correct_incorrect.md)
  ...
  [`mark_as()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/mark_as_correct_incorrect.md)
...
- [`random_praise()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/random_praise.md)
  ...
  : Random praise and encouragement
- [`random_phrases_add()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/random_phrases_add.md)
...
- [`disable_all_tags()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/disable_all_tags.md)
  : Disable all html tags
- [`finalize_question()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/finalize_question.md)
  : Finalize a question
- [`question_ui_initialize()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/question_methods.md)
  [`question_ui_try_again()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/question_methods.md)
  [`question_ui_completed()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/question_methods.md)
  [`question_is_valid()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/question_methods.md)
  [`question_is_correct()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/question_methods.md)
  : Custom question methods
- [`knit_print(`*`<tutorial_question>`*`)`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/knit_print.md)
  [`knit_print(`*`<tutorial_quiz>`*`)`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/knit_print.md)
  : Knitr quiz print methods
- [`format(`*`<tutorial_question_answer>`*`)`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/format_quiz.md)
  [`format(`*`<tutorial_question>`*`)`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/format_quiz.md)
  [`format(`*`<tutorial_quiz>`*`)`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/format_quiz.md)
  [`print(`*`<tutorial_question>`*`)`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/format_quiz.md)
  [`print(`*`<tutorial_question_answer>`*`)`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/format_quiz.md)
  [`print(`*`<tutorial_quiz>`*`)`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/format_quiz.md)
...
- [`filesystem_storage()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/filesystem_storage.md)
...
- [`duplicate_env()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/duplicate_env.md)
  : Create a duplicate of an environment
- [`initialize_tutorial()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/initialize_tutorial.md)
...
- [`tutorial_html_dependency()`](https:/pkgs.rstudio.com/learnr/v0.11.6/reference/tutorial_html_dependency.md)
