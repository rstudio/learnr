...
output$tutorial_user_state <- renderPrint({
  ...
  str(reactiveValuesToList(session$userData$tutorial_state))
})
```
...
Write the R code required to add two plus two. This is graded, so only submissions are recorded in the tutorial state.
