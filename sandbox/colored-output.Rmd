...
```
{r car-red, exercise.alert_class = "red"}
```

```{r car-red, exercise.alert_class = "red", exercise=TRUE}
list(
```
...
```{r car-orange, exercise.alert_class = "orange", exercise=TRUE,  exercise.timelimit = 10}
list(
```
...
`exercise.alert_class = "purple"`

```{r car-purple, exercise.alert_class = "purple", exercise=TRUE,  exercise.timelimit = 10}
list(
```
...
`exercise.alert_class = "blue"`

```{r car-blue, exercise.alert_class = "blue", exercise=TRUE,  exercise.timelimit = 10}
list(
```
...
`exercise.alert_class = "violet"`

```{r car-violet, exercise.alert_class = "violet", exercise=TRUE,  exercise.timelimit = 10}
list(
```
...
`exercise.alert_class = "yellow"`

```{r car-yellow, exercise.alert_class = "yellow", exercise=TRUE,  exercise.timelimit = 10}
list(
```
...
`exercise.alert_class = "pink"`

```{r car-pink, exercise.alert_class = "pink", exercise=TRUE,  exercise.timelimit = 10}
list(
```
...
`exercise.alert_class = "green"`

```{r car-green, exercise.alert_class = "green", exercise=TRUE, exercise.timelimit = 10}
list(
```
