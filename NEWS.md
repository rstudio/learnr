...
* Tutorial authors can now access the current state of the user's progress in a tutorial with `get_tutorial_state()`. ([#562](https://github.com/rstudio/learnr/pull/562))
