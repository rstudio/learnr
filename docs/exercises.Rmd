...
Note that this feature is only available if you are using the [`tutor::tutorial`](formats.html#tutorial-format) R Markdown format (other custom formats may have their own internal mechanisms for progressive reveal).
