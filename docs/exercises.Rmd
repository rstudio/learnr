...
<td>Caption for exercise chunk (defaults to "R Code")</td>
</tr>
<tr class="even">
...
By default exercises are displayed with caption of "R Code". However, in some cases you may want either a custom per-chunk caption or a generic caption with a different connodation (e.g. "Exercise" or Sandbox"). For example:
