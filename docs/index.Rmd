...
The most straightforward way to deploy a tutorial is to include it within an R package and have users run it directly via the `tutor::run_tutorial` function.
